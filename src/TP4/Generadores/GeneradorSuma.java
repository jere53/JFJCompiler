...
public class GeneradorSuma {
    ...
    public static String getASM() {
        RegistroTS op1 = (RegistroTS) pila_variables.pop();
        RegistroTS op2 = (RegistroTS) pila_variables.pop();
        ...
        // FLAGS
        // Despues de cada suma se tiene que verificar el registro CF para ver si hubo carry flag para enteros sin signo
        // Despues de cada suma se tiene que verificar el registro CF para ver si hubo carry flag para enteros sin signo

        // Despues de cada suma se tiene que verificar el registro CF para ver si hubo carry flag para enteros sin signo
        // En caso de ser1 el valor de este registro se debe lanzar una subrutina encargada delk handling del overflow en este caso
        // Esta rutina deberia imprimir un mensaje y terminar el programa

        if (TablaSimbolos.punteroTS(nombre_auxiliar) == null){
            System.out.println(nombre_auxiliar);
