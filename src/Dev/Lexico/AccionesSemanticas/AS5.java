    ...
    public Dupla<Integer, RegistroTS> ejecutar(int estadoActual, Character c) {
        ...
        if (estadoActual == 2) {
            ...
            try {
                ...
                return new Dupla<>(AnalizadorLexico.numeroToken.get("CTE_UINT"), TablaSimbolos.punteroTS(lexema));
            ...
            try {
                ...
                return new Dupla<>(AnalizadorLexico.numeroToken.get("CTE_DOUBLE"), TablaSimbolos.punteroTS(lexema));
