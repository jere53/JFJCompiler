...
public class Polaca {
    ...
    public static Object conseguir(int indice){
        return representacionIntermedia.get(indice);
    }

    public static Object conseguirUltimo(){
        return representacionIntermedia.get(representacionIntermedia.size()-1);
    }
  ...
  REPEAT
   ...
   UNTIL
    ...
    public static int size(){
        return representacionIntermedia.size();
    }
